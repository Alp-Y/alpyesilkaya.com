...
order: 2
demo: exv
summary: From surveyed coordinates to verified quantities. Survey points become terrain surfaces, and the excavation volume is calculated across the surface itself — with section views along the way.
platform:
stack:
status:
version:
